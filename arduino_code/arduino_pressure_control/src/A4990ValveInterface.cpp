...
void A4990ValveInterface::setValve0Speed(short speed)
{
  if (speed <= 0)
  { // vent
...
// speed should be a number between -400 and 400
void A4990ValveInterface::setValve1Speed(short speed)
{
  if (speed <= 0)
  { // vent
...
// speed should be a number between -400 and 400
void A4990ValveInterface::setValve2Speed(short speed)
{
  if (speed <= 0)
  { // vent
...
// speed should be a number between -400 and 400
void A4990ValveInterface::setValve3Speed(short speed)
{
  if (speed <= 0)
  { // vent
...
// speed should be a number between -400 and 400
void A4990ValveInterface::setSpeeds(short valve_cmd[4])
{
